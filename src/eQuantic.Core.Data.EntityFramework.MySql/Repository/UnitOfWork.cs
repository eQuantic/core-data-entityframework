...
/// <summary>
///     MySQL unit of work. The implementation lives in <see cref="RelationalUnitOfWork{TDbContext}" />;
///     MySQL uses the default ANSI <c>CALL</c> stored-procedure dialect, so no dialect override is
///     required.
/// </summary>
